      ...
      `}</style>
            ...
            <div className="relative z-10 pt-28 sm:pt-32 md:pt-36">
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                    ...
                    >
                        APP.UI is a comprehensive UI component library and design system that provides developers with pre-built, customizable React components to accelerate app development while maintaining design consistency.
                    </motion.p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
                        ...
                        >
                            <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                                The mission of APP.UI is to empower developers with a robust, accessible, and beautifully designed component library that reduces development time while ensuring pixel-perfect interfaces across all devices.
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-20 md:py-24">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
                        ...
                        >
                            <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                                The biggest challenge was creating a flexible theming system that allows deep customization while maintaining consistent design tokens, accessibility standards, and smooth animations across all components.
                            </p>
                        </motion.div>
                    </div>
                </div>
