    ...
    <div className="relative min-h-screen text-white playwrite-nz-basic">
      ...
      <div className="relative z-10 pt-28 sm:pt-32 md:pt-36">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          >
            Pestorix: professional pest control template with service listings,
            instant quotes, interactive maps, case studies and safety guides.
          </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
            ...
            >
              <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                Pestorix wanted a pest control template for residential, commercial and
                industrial services with instant quote requests and safety information. They
                needed an interactive service area map, a case study gallery with before-and-
                after images, and a blog for prevention tips. Quick access to emergency
                contacts and maintenance schedules was absolutely crucial.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-20 md:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
            ...
            >
              <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque euismod, nisi eu consectetur consectetur, nisl nisi consectetur nisi, euismod euismod nisi nisi euismod. (Edit this text later)
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-[#f6e97b]/30 rounded-[24px] overflow-hidden flex flex-col items-center p-6">
              ...
              <div className="w-full flex flex-col items-start">
                <span className="text-[20px] sm:text-[24px] md:text-[28px] font-light mb-1" style={{ fontFamily: 'serif' }}>Didasko</span>
            ...
            <div className="bg-white/10 rounded-[24px] overflow-hidden flex flex-col items-center p-6">
              ...
              <div className="w-full flex flex-col items-start">
                <span className="text-[20px] sm:text-[24px] md:text-[28px] font-light mb-1" style={{ fontFamily: 'serif' }}>Harmonix</span>
                <span className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] font-light">2024</span>
              </div>
            </div>
          </div>
