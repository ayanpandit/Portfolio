...
import projectMainImage from '../assets/project6.svg';
import projectChallengeImage from '../assets/project6_2.png';
      ...
      `}</style>
            ...
            <div className="relative z-10 pt-28 sm:pt-32 md:pt-36">
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                    ...
                    >
                        YouGO is an AI-powered social travel ecosystem that blends smart itinerary planning with a verified community to help you find compatible travel partners.
                    </motion.p>
                    ...
                    >
                        <button
                            type="button"
                            onClick={() => window.open('https://yugo-web-blond.vercel.app/#/', '_blank', 'noopener,noreferrer')}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
                        ...
                        >
                            <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                                To empower you to explore the world freely and confidently, ensuring your travel dreams never die just because your friends canceled.
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-20 md:py-24">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
                        ...
                        >
                            <p className="text-gray-400 text-[13px] sm:text-[14px] md:text-[15px] leading-[1.6] font-light">
                               It directly solves the heartbreak of flaky group chats, the safety and loneliness concerns of solo travel, and the overwhelming fatigue of planning a trip from scratch.
                               </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-16 sm:py-20 md:py-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        {/* Project 4 - Splitly */}
                        <div 
                            className="bg-[#DDA0DD]/30 rounded-[24px] overflow-hidden flex flex-col items-center p-6 cursor-pointer hover:scale-[1.02] transition-transform"
                            onClick={() => navigate('/project/4')}
                        >
                            <div className="w-full aspect-[16/9] rounded-[16px] overflow-hidden mb-6 border border-white/10">
                                <SkeletonImage src={project4Image} alt="Splitly" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-full flex flex-col items-start">
                                <span className="text-[20px] sm:text-[24px] md:text-[28px] font-light mb-1" style={{ fontFamily: 'serif' }}>Splitly</span>
